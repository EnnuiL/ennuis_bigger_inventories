...
public class ModScreenHandlerTypes {
	...
	public static void register() {
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x1"), GENERIC_10X1);
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x2"), GENERIC_10X2);
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x3"), GENERIC_10X3);
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x4"), GENERIC_10X4);
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x5"), GENERIC_10X5);
		Registry.register(Registries.SCREEN_HANDLER_TYPE, new Identifier("ennuis_bigger_inventories", "generic_10x6"), GENERIC_10X6);
	}
}
